...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "howto.step1": "Pick the HANA revision (top-right) so each analysis uses the matching SQL.",
      "howto.step2": "Connect to HANA via SAP GUI (DBACOCKPIT) with the Connect button.",
      ...
      "analysis.a1_top_tables.short": "A1: Top Tables by Size",
      "analysis.a2_db_size_history.short": "A2: DB Size & Memory History",
      "analysis.a3_memory_overview.short": "A3: Memory Overview",
      "analysis.a4_top_growing.short": "A4: Top Growing Tables (30d)",
      "analysis.a5_partitioned_tables.short": "A5: Partitioned Tables",
    ...
    es: {
      ...
      "howto.step1": "Elige la revisión de HANA (arriba a la derecha) para que cada análisis use el SQL correspondiente.",
      "howto.step2": "Conéctate a HANA vía SAP GUI (DBACOCKPIT) con el botón Conectar.",
      ...
      "analysis.a1_top_tables.short": "A1: Tablas más grandes por tamaño",
      "analysis.a2_db_size_history.short": "A2: Historial de tamaño de BD y memoria",
      "analysis.a3_memory_overview.short": "A3: Resumen de memoria",
      "analysis.a4_top_growing.short": "A4: Tablas de mayor crecimiento (30d)",
      "analysis.a5_partitioned_tables.short": "A5: Tablas particionadas",
    ...
    pt: {
      ...
      "howto.step1": "Escolha a revisão do HANA (canto superior direito) para que cada análise use o SQL correspondente.",
      "howto.step2": "Conecte-se ao HANA via SAP GUI (DBACOCKPIT) com o botão Conectar.",
      ...
      "analysis.a1_top_tables.short": "A1: Maiores tabelas por tamanho",
      "analysis.a2_db_size_history.short": "A2: Histórico de tamanho do BD e memória",
      "analysis.a3_memory_overview.short": "A3: Visão geral de memória",
      "analysis.a4_top_growing.short": "A4: Tabelas com maior crescimento (30d)",
      "analysis.a5_partitioned_tables.short": "A5: Tabelas particionadas",
